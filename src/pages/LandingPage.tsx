          ...
          <div className="mx-auto max-w-6xl flex items-center justify-between gap-2 sm:gap-4 rounded-2xl border border-white/[0.07] bg-white/[0.025] backdrop-blur-xl px-3 sm:px-5 py-2.5 sm:py-3 shadow-2xl shadow-black/40">
            ...
            <Link to="/" className="flex items-center gap-2 sm:gap-3 min-w-0 group">
              <div className="relative shrink-0">
                <div className="absolute -inset-0.5 rounded-xl bg-gradient-to-br from-cyan-500/40 via-blue-500/40 to-indigo-600/40 blur-md opacity-70 group-hover:opacity-100 transition-opacity" />
                <img
                  src="/school logo.jpg"
                  alt="School Logo"
              ...
              <div className="hidden sm:block min-w-0">
                <div className="text-[11px] font-bold text-white leading-tight">
                  {isArabic ? "مدرسة الملك حسين بن طلال" : "King Hussein School"}
                </div>
                <div className="text-[9px] text-white/80 font-medium tracking-wide">
                  {isArabic ? "الثانوية الشاملة للبنين" : "Secondary Comprehensive for Boys"}
                </div>
              </div>
            </Link>
            ...
            <div className="flex items-center gap-2 sm:gap-3 min-w-0">
              <div className="hidden sm:block min-w-0 text-right">
                ...
                <div className="text-[9px] text-white/80 font-medium tracking-wide">
                  {isArabic ? "المملكة الأردنية الهاشمية" : "Hashemite Kingdom of Jordan"}
                </div>
              </div>
              <div className="relative shrink-0">
                <div className="absolute -inset-0.5 rounded-xl bg-gradient-to-br from-cyan-500/40 via-blue-500/40 to-indigo-600/40 blur-md opacity-70" />
                <img
                  src="/ministery of education logo.webp"
                  alt={isArabic ? "وزارة التربية والتعليم المملكة الأردنية الهاشمية" : "Ministry of Education - Hashemite Kingdom of Jordan"}
          ...
          >
            ...
            <div className="flex flex-col gap-3 sm:gap-4 items-center">
              ...
              <motion.a
                ...
                className="group w-full max-w-xl relative overflow-hidden rounded-2xl p-[1px] bg-gradient-to-r from-cyan-500/60 via-blue-500/50 to-indigo-600/60"
              ...
              >
                <div className="relative rounded-[15px] bg-slate-950/90 backdrop-blur-xl px-5 sm:px-6 py-4 sm:py-5 flex items-center justify-between gap-3 sm:gap-4">
                  ...
                  <div className="relative flex items-center gap-3 sm:gap-4 min-w-0">
                    <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-xl bg-cyan-500/15 border border-cyan-500/20 flex items-center justify-center group-hover:bg-cyan-500/25 transition-colors shrink-0">
                      <Facebook className="w-4 h-4 sm:w-5 sm:h-5 text-cyan-400" />
                    </div>
                    <div className="min-w-0">
                      <div className="text-[9px] sm:text-[10px] text-white/70 uppercase tracking-[0.2em] font-bold mb-0.5">
                        {isArabic ? "صفحة فيسبوك" : "Facebook Page"}
                      </div>
                      <div className="text-sm sm:text-base font-bold text-white truncate">
                        {isArabic ? "وزارة التربية والتعليم المملكة الأردنية الهاشمية" : "Ministry of Education - Jordan"}
                      </div>
                    </div>
                  </div>
                  <ExternalLink className="relative w-4 h-4 text-slate-500 group-hover:text-cyan-400 transition-colors flex-shrink-0" />
                </div>
              </motion.a>
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="text-sm sm:text-base font-bold text-white truncate">
                        {isArabic
                          ...
                          : "King Hussein Secondary Comprehensive School"}
                      </div>
                    </div>
                  </div>
                  <ExternalLink className="relative w-4 h-4 text-slate-500 group-hover:text-cyan-400 transition-colors flex-shrink-0" />
