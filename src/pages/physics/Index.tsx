...
import { Zap, Flame, Waves, Atom, Rocket, BookOpen, Calculator, ArrowRightLeft, BookA, Trophy, Eye } from "lucide-react";
...
const branches = [
  ...
  { path: "/physics/optics", labelKey: "physics.navigation.optics", icon: Eye, color: "text-cyan-400", border: "border-cyan-400/30", descKey: "physics.optics.description" },
