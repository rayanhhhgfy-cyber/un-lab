...
export const reactions: Reaction[] = [
  ...
  { id: 'lih', reactants: ['Li', 'H2'], eq: 'Li + H₂ → LiH', balanced: '2Li + H₂ → 2LiH', products: ['LiH'], type: 'synthesis', visual: 'smoke', color: 'hsl(0,0%,90%)', enthalpy: -90.5, desc: 'Lithium reacts with hydrogen gas to form lithium hydride.', temp: '300-400°C', realUse: 'Hydrogen storage, reducing agent' },
  { id: 'nah', reactants: ['Na', 'H2'], eq: 'Na + H₂ → NaH', balanced: '2Na + H₂ → 2NaH', products: ['NaH'], type: 'synthesis', visual: 'smoke', color: 'hsl(45,90%,60%)', enthalpy: -56.3, desc: 'Sodium reacts with hydrogen to form sodium hydride.', temp: '200-300°C', realUse: 'Strong base in organic synthesis' },
  { id: 'kh', reactants: ['K', 'H2'], eq: 'K + H₂ → KH', balanced: '2K + H₂ → 2KH', products: ['KH'], type: 'synthesis', visual: 'smoke', color: 'hsl(280,60%,65%)', enthalpy: -58.2, desc: 'Potassium reacts with hydrogen to form potassium hydride.', temp: '200-300°C', realUse: 'Superbase, organic synthesis' },
  { id: 'cah2', reactants: ['Ca', 'H2'], eq: 'Ca + H₂ → CaH₂', balanced: 'Ca + H₂ → CaH₂', products: ['CaH2'], type: 'synthesis', visual: 'smoke', color: 'hsl(0,0%,95%)', enthalpy: -186.2, desc: 'Calcium reacts with hydrogen to form calcium hydride.', temp: '300-400°C', realUse: 'Drying agent, portable hydrogen source' },
  { id: 'mgh2', reactants: ['Mg', 'H2'], eq: 'Mg + H₂ → MgH₂', balanced: 'Mg + H₂ → MgH₂', products: ['MgH2'], type: 'synthesis', visual: 'smoke', color: 'hsl(120,50%,60%)', enthalpy: -75.3, desc: 'Magnesium reacts with hydrogen to form magnesium hydride.', temp: '300-400°C, high pressure', realUse: 'Hydrogen storage research' },
  ...
  // PHOSPHORUS REACTIONS
  { id: 'p2o5', reactants: ['P', 'O2'], eq: 'P + O₂ → P₂O₅', balanced: '4P + 5O₂ → 2P₂O₅', products: ['Phosphorus Pentoxide'], type: 'combustion', visual: 'smoke', color: 'hsl(0,0%,85%)', enthalpy: -1492.0, desc: 'White phosphorus ignites spontaneously in air.', safety: '⚠️ PYROPHORIC! Ignites at 34°C!', temp: 'Spontaneous >34°C', realUse: 'Phosphoric acid, drying agent' },

  // CHLORINE REACTIONS
  { id: 'hcl', reactants: ['H2', 'Cl2'], eq: 'H₂ + Cl₂ → HCl', balanced: 'H₂ + Cl₂ → 2HCl', products: ['Hydrochloric Acid (HCl)'], type: 'synthesis', visual: 'smoke', color: 'hsl(120,40%,50%)', enthalpy: -184.6, desc: 'Hydrogen and chlorine form hydrochloric acid.', safety: '⚠️ HCl is corrosive!', temp: 'UV or >250°C', realUse: 'Industrial HCl, PVC production' },
  ...
  // ALUMINUM BROMIDE
  { id: 'albr3', reactants: ['Al', 'Br2'], eq: 'Al + Br₂ → AlBr₃', balanced: '2Al + 3Br₂ → 2AlBr₃', products: ['Aluminum Bromide'], type: 'synthesis', visual: 'smoke', color: 'hsl(15,60%,50%)', enthalpy: -527.2, desc: 'Vigorous reaction producing smoke.', safety: '⚠️ Bromine is very corrosive!', temp: 'Room temp', realUse: 'Friedel-Crafts catalyst, synthesis' },
  { id: 'bebr2', reactants: ['Be', 'Br2'], eq: 'Be + Br₂ → BeBr₂', balanced: 'Be + Br₂ → BeBr₂', products: ['Beryllium Bromide (BeBr₂)'], type: 'synthesis', visual: 'smoke', color: 'hsl(0,0%,80%)', enthalpy: -378.2, desc: 'Beryllium reacts with bromine.', safety: '⚠️ Br₂ is toxic! Be is toxic!', temp: 'Room temp', realUse: 'Research, synthesis' },
  ...
  { id: 'rabr2', reactants: ['Ra', 'Br2'], eq: 'Ra + Br₂ → RaBr₂', balanced: 'Ra + Br₂ → RaBr₂', products: ['Radium Bromide (RaBr₂)'], type: 'synthesis', visual: 'smoke', color: 'hsl(0,0%,75%)', enthalpy: -735.0, desc: 'Radium reacts with bromine.', safety: '⚠️ Br₂ is toxic! Ra is radioactive!', temp: 'Room temp', realUse: 'Research' },
  ...
  { id: 'bcl3', reactants: ['B', 'Cl2'], eq: 'B + Cl₂ → BCl₃', balanced: '2B + 3Cl₂ → 2BCl₃', products: ['Boron Trichloride (BCl₃)'], type: 'synthesis', visual: 'smoke', color: 'hsl(0,0%,85%)', enthalpy: -427.0, desc: 'Boron reacts with chlorine.', safety: '⚠️ Cl₂ is toxic!', temp: 'Room temp', realUse: 'Catalysis, semiconductors' },
  ...
  { id: 'gacl3', reactants: ['Ga', 'Cl2'], eq: 'Ga + Cl₂ → GaCl₃', balanced: '2Ga + 3Cl₂ → 2GaCl₃', products: ['Gallium Trichloride (GaCl₃)'], type: 'synthesis', visual: 'smoke', color: 'hsl(0,0%,80%)', enthalpy: -523.0, desc: 'Gallium reacts with chlorine.', safety: '⚠️ Cl₂ is toxic!', temp: 'Room temp', realUse: 'Semiconductors, research' },
  ...
  { id: 'incl3', reactants: ['In', 'Cl2'], eq: 'In + Cl₂ → InCl₃', balanced: '2In + 3Cl₂ → 2InCl₃', products: ['Indium Trichloride (InCl₃)'], type: 'synthesis', visual: 'smoke', color: 'hsl(0,0%,75%)', enthalpy: -537.0, desc: 'Indium reacts with chlorine.', safety: '⚠️ Cl₂ is toxic!', temp: 'Room temp', realUse: 'Catalysis, research' },
  ...
  { id: 'tlcl', reactants: ['Tl', 'Cl2'], eq: 'Tl + Cl₂ → TlCl', balanced: '2Tl + Cl₂ → 2TlCl', products: ['Thallium Chloride (TlCl)'], type: 'synthesis', visual: 'smoke', color: 'hsl(0,0%,75%)', enthalpy: -205.0, desc: 'Thallium reacts with chlorine.', safety: '⚠️ Cl₂ is toxic! Tl is toxic!', temp: 'Room temp', realUse: 'Research' },
  ...
  { id: 'znbr2', reactants: ['Zn', 'Br2'], eq: 'Zn + Br₂ → ZnBr₂', balanced: 'Zn + Br₂ → ZnBr₂', products: ['Zinc Bromide (ZnBr₂)'], type: 'synthesis', visual: 'smoke', color: 'hsl(0,0%,80%)', enthalpy: -329.7, desc: 'Zinc reacts with bromine.', safety: '⚠️ Br₂ is toxic!', temp: 'Room temp', realUse: 'Research, medicine' },
  ...
  { id: 'p4-cl2', reactants: ['P4', 'Cl2'], eq: 'P₄ + 10Cl₂ → 4PCl₅', balanced: 'P₄ + 10Cl₂ → 4PCl₅', products: ['PCl5'], type: 'synthesis', visual: 'smoke', color: 'hsl(0,0%,80%)', enthalpy: -2450.0, desc: 'White phosphorus reacts with excess chlorine forming PCl₅.', temp: 'Room temp', realUse: 'Organic synthesis, chlorination' },
  ...
  { id: 'contactprocess', reactants: ['S', 'O2'], eq: '2SO₂ + O₂ → 2SO₃', balanced: '2SO₂ + O₂ ⇌ 2SO₃', products: ['Sulfur Trioxide'], type: 'oxidation', visual: 'smoke', color: 'hsl(0,0%,90%)', enthalpy: -198.2, desc: 'Contact process for sulfuric acid production.', temp: '400-600°C', catalyst: 'V₂O₅', realUse: 'Sulfuric acid, detergents' },

  // BIOCHEMICAL REACTIONS

  // CATALYTIC REACTIONS
  { id: 'catalyticcracking', reactants: ['C', 'H2'], eq: 'C₁₆H₃₄ → C₈H₁₈ + C₈H₁₆', balanced: 'C₁₆H₃₄ → C₈H₁₈ + C₈H₁₆', products: ['Octane', 'Octene'], type: 'decomposition', visual: 'smoke', color: 'hsl(0,0%,80%)', enthalpy: 50.0, desc: 'Catalytic cracking of hydrocarbons.', temp: '500°C', catalyst: 'Zeolite', realUse: 'Petroleum refining, gasoline' },
  ...
  { id: 'auto_Be_F2', reactants: ["Be", "F2"], eq: 'Be + F2 → BeF2', balanced: 'Be + F2 → BeF2', products: ["BeF2"], type: 'synthesis', visual: 'smoke', color: 'hsl(0,0%,85%)', enthalpy: -600, desc: 'Be reacts with F2 to form BeF2.', realUse: 'Halide formation' },
  { id: 'auto_Be_Cl2', reactants: ["Be", "Cl2"], eq: 'Be + Cl2 → BeCl2', balanced: 'Be + Cl2 → BeCl2', products: ["BeCl2"], type: 'synthesis', visual: 'smoke', color: 'hsl(0,0%,85%)', enthalpy: -600, desc: 'Be reacts with Cl2 to form BeCl2.', realUse: 'Halide formation' },
  { id: 'auto_Be_Br2', reactants: ["Be", "Br2"], eq: 'Be + Br2 → BeBr2', balanced: 'Be + Br2 → BeBr2', products: ["BeBr2"], type: 'synthesis', visual: 'smoke', color: 'hsl(0,0%,85%)', enthalpy: -600, desc: 'Be reacts with Br2 to form BeBr2.', realUse: 'Halide formation' },
  { id: 'auto_Be_I2', reactants: ["Be", "I2"], eq: 'Be + I2 → BeI2', balanced: 'Be + I2 → BeI2', products: ["BeI2"], type: 'synthesis', visual: 'smoke', color: 'hsl(0,0%,85%)', enthalpy: -600, desc: 'Be reacts with I2 to form BeI2.', realUse: 'Halide formation' },
  { id: 'auto_Mg_F2', reactants: ["Mg", "F2"], eq: 'Mg + F2 → MgF2', balanced: 'Mg + F2 → MgF2', products: ["MgF2"], type: 'synthesis', visual: 'smoke', color: 'hsl(120,50%,60%)', enthalpy: -600, desc: 'Mg reacts with F2 to form MgF2.', realUse: 'Halide formation' },
  { id: 'auto_Mg_Cl2', reactants: ["Mg", "Cl2"], eq: 'Mg + Cl2 → MgCl2', balanced: 'Mg + Cl2 → MgCl2', products: ["MgCl2"], type: 'synthesis', visual: 'smoke', color: 'hsl(120,50%,60%)', enthalpy: -600, desc: 'Mg reacts with Cl2 to form MgCl2.', realUse: 'Halide formation' },
  { id: 'auto_Mg_Br2', reactants: ["Mg", "Br2"], eq: 'Mg + Br2 → MgBr2', balanced: 'Mg + Br2 → MgBr2', products: ["MgBr2"], type: 'synthesis', visual: 'smoke', color: 'hsl(120,50%,60%)', enthalpy: -600, desc: 'Mg reacts with Br2 to form MgBr2.', realUse: 'Halide formation' },
  { id: 'auto_Mg_I2', reactants: ["Mg", "I2"], eq: 'Mg + I2 → MgI2', balanced: 'Mg + I2 → MgI2', products: ["MgI2"], type: 'synthesis', visual: 'smoke', color: 'hsl(120,50%,60%)', enthalpy: -600, desc: 'Mg reacts with I2 to form MgI2.', realUse: 'Halide formation' },
  { id: 'auto_Ca_F2', reactants: ["Ca", "F2"], eq: 'Ca + F2 → CaF2', balanced: 'Ca + F2 → CaF2', products: ["CaF2"], type: 'synthesis', visual: 'smoke', color: 'hsl(0,0%,90%)', enthalpy: -600, desc: 'Ca reacts with F2 to form CaF2.', realUse: 'Halide formation' },
  { id: 'auto_Ca_Cl2', reactants: ["Ca", "Cl2"], eq: 'Ca + Cl2 → CaCl2', balanced: 'Ca + Cl2 → CaCl2', products: ["CaCl2"], type: 'synthesis', visual: 'smoke', color: 'hsl(0,0%,90%)', enthalpy: -600, desc: 'Ca reacts with Cl2 to form CaCl2.', realUse: 'Halide formation' },
  { id: 'auto_Ca_Br2', reactants: ["Ca", "Br2"], eq: 'Ca + Br2 → CaBr2', balanced: 'Ca + Br2 → CaBr2', products: ["CaBr2"], type: 'synthesis', visual: 'smoke', color: 'hsl(0,0%,90%)', enthalpy: -600, desc: 'Ca reacts with Br2 to form CaBr2.', realUse: 'Halide formation' },
  { id: 'auto_Ca_I2', reactants: ["Ca", "I2"], eq: 'Ca + I2 → CaI2', balanced: 'Ca + I2 → CaI2', products: ["CaI2"], type: 'synthesis', visual: 'smoke', color: 'hsl(0,0%,90%)', enthalpy: -600, desc: 'Ca reacts with I2 to form CaI2.', realUse: 'Halide formation' },
  { id: 'auto_Sr_F2', reactants: ["Sr", "F2"], eq: 'Sr + F2 → SrF2', balanced: 'Sr + F2 → SrF2', products: ["SrF2"], type: 'synthesis', visual: 'smoke', color: 'hsl(0,0%,85%)', enthalpy: -600, desc: 'Sr reacts with F2 to form SrF2.', realUse: 'Halide formation' },
  { id: 'auto_Sr_Cl2', reactants: ["Sr", "Cl2"], eq: 'Sr + Cl2 → SrCl2', balanced: 'Sr + Cl2 → SrCl2', products: ["SrCl2"], type: 'synthesis', visual: 'smoke', color: 'hsl(0,0%,85%)', enthalpy: -600, desc: 'Sr reacts with Cl2 to form SrCl2.', realUse: 'Halide formation' },
  { id: 'auto_Sr_Br2', reactants: ["Sr", "Br2"], eq: 'Sr + Br2 → SrBr2', balanced: 'Sr + Br2 → SrBr2', products: ["SrBr2"], type: 'synthesis', visual: 'smoke', color: 'hsl(0,0%,85%)', enthalpy: -600, desc: 'Sr reacts with Br2 to form SrBr2.', realUse: 'Halide formation' },
  { id: 'auto_Sr_I2', reactants: ["Sr", "I2"], eq: 'Sr + I2 → SrI2', balanced: 'Sr + I2 → SrI2', products: ["SrI2"], type: 'synthesis', visual: 'smoke', color: 'hsl(0,0%,85%)', enthalpy: -600, desc: 'Sr reacts with I2 to form SrI2.', realUse: 'Halide formation' },
  { id: 'auto_Ba_F2', reactants: ["Ba", "F2"], eq: 'Ba + F2 → BaF2', balanced: 'Ba + F2 → BaF2', products: ["BaF2"], type: 'synthesis', visual: 'smoke', color: 'hsl(120,60%,50%)', enthalpy: -600, desc: 'Ba reacts with F2 to form BaF2.', realUse: 'Halide formation' },
  { id: 'auto_Ba_Cl2', reactants: ["Ba", "Cl2"], eq: 'Ba + Cl2 → BaCl2', balanced: 'Ba + Cl2 → BaCl2', products: ["BaCl2"], type: 'synthesis', visual: 'smoke', color: 'hsl(120,60%,50%)', enthalpy: -600, desc: 'Ba reacts with Cl2 to form BaCl2.', realUse: 'Halide formation' },
  { id: 'auto_Ba_Br2', reactants: ["Ba", "Br2"], eq: 'Ba + Br2 → BaBr2', balanced: 'Ba + Br2 → BaBr2', products: ["BaBr2"], type: 'synthesis', visual: 'smoke', color: 'hsl(120,60%,50%)', enthalpy: -600, desc: 'Ba reacts with Br2 to form BaBr2.', realUse: 'Halide formation' },
  { id: 'auto_Ba_I2', reactants: ["Ba", "I2"], eq: 'Ba + I2 → BaI2', balanced: 'Ba + I2 → BaI2', products: ["BaI2"], type: 'synthesis', visual: 'smoke', color: 'hsl(120,60%,50%)', enthalpy: -600, desc: 'Ba reacts with I2 to form BaI2.', realUse: 'Halide formation' },
