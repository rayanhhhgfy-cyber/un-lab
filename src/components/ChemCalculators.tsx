  ...
  return (
    <div className="space-y-5 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-wrap gap-2 p-1 bg-black/40 rounded-lg w-fit">
        ...
        <button onClick={() => setMode('density')} className={`px-4 py-1.5 rounded-md text-xs font-bold transition-all ${mode === 'density' ? 'bg-cyan-500/20 text-cyan-300 shadow-sm' : 'text-muted-foreground hover:text-white'}`}>Density Mode</button>
      </div>
