...
const labRoutes: Array<{
  ...
  { id: "lab-math", label: "Mathematics Portal", hint: "Hub, solvers, formulas, converters, glossary", href: "/mathematics", Icon: Sigma, color: "from-violet-400 to-fuchsia-500" },
  { id: "lab-math-solver", label: "Math · Equation solver", hint: "Quadratic, linear 2×2, gcd, sequences", href: "/mathematics/tools/solver", Icon: Sigma, color: "from-violet-400 to-purple-500" },
  { id: "lab-math-formulas", label: "Math · Formula library", hint: "Algebra, trig, calculus, stats", href: "/mathematics/tools/formulas", Icon: Sigma, color: "from-fuchsia-400 to-pink-500" },
  { id: "lab-math-converter", label: "Math · Converters", hint: "Degrees, polar, lengths", href: "/mathematics/tools/converter", Icon: Sigma, color: "from-cyan-400 to-violet-500" },
  { id: "lab-math-glossary", label: "Math · Glossary", hint: "Definitions & tags", href: "/mathematics/glossary", Icon: Sigma, color: "from-indigo-400 to-blue-500" },
  { id: "lab-math-workspace", label: "Math · Workspace", hint: "Decimals, notation, starred branches", href: "/mathematics/workspace", Icon: Sigma, color: "from-amber-400 to-orange-500" },
  { id: "lab-math-calculus", label: "Math · Calculus", hint: "Riemann sums, tangents, Taylor series", href: "/mathematics/calculus", Icon: Sigma, color: "from-violet-400 to-indigo-500" },
  { id: "lab-math-algebra", label: "Math · Algebra", hint: "Quadratics & complex multiply", href: "/mathematics/algebra", Icon: Sigma, color: "from-fuchsia-400 to-purple-500" },
  { id: "lab-math-trig", label: "Math · Trigonometry", hint: "Unit circle, waves, Fourier", href: "/mathematics/trigonometry", Icon: Sigma, color: "from-indigo-400 to-violet-500" },
  { id: "lab-math-geometry", label: "Math · Geometry", hint: "Matrices, Bézier, Mandelbrot", href: "/mathematics/geometry", Icon: Sigma, color: "from-purple-400 to-pink-500" },
  { id: "lab-math-stats", label: "Math · Statistics", hint: "Normal law & binomial sampling", href: "/mathematics/statistics", Icon: Sigma, color: "from-cyan-400 to-violet-500" },
  { id: "lab-math-dynamics", label: "Math · Dynamics", hint: "Logistic map & Fibonacci spiral", href: "/mathematics/dynamics", Icon: Sigma, color: "from-pink-400 to-rose-500" },
